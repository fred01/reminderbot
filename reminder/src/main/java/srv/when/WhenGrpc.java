...
public final class WhenGrpc {
  ...
  public static final io.grpc.MethodDescriptor<WhenRequest,
          WhenResponse> METHOD_PARSE = getParseMethodHelper();

  private static volatile io.grpc.MethodDescriptor<WhenRequest,
          WhenResponse> getParseMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<WhenRequest,
          WhenResponse> getParseMethod() {
    return getParseMethodHelper();
  }

  private static io.grpc.MethodDescriptor<WhenRequest,
          WhenResponse> getParseMethodHelper() {
    io.grpc.MethodDescriptor<WhenRequest, WhenResponse> getParseMethod;
    if ((getParseMethod = WhenGrpc.getParseMethod) == null) {
      synchronized (WhenGrpc.class) {
        if ((getParseMethod = WhenGrpc.getParseMethod) == null) {
          WhenGrpc.getParseMethod = getParseMethod = 
              io.grpc.MethodDescriptor.<WhenRequest, WhenResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "main.When", "Parse"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  WhenRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  WhenResponse.getDefaultInstance()))
  ...
  public static abstract class WhenImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void parse(WhenRequest request,
                      io.grpc.stub.StreamObserver<WhenResponse> responseObserver) {
  ...
  public static final class WhenBlockingStub extends io.grpc.stub.AbstractStub<WhenBlockingStub> {
     ...
     * </pre>
     */
    public WhenResponse parse(WhenRequest request) {
  ...
  public static final class WhenFutureStub extends io.grpc.stub.AbstractStub<WhenFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<WhenResponse> parse(
        WhenRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PARSE:
          serviceImpl.parse((WhenRequest) request,
              (io.grpc.stub.StreamObserver<WhenResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class WhenBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return WhenService.getDescriptor();
    }
